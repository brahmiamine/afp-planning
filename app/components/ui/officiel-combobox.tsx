  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          <span
            className={cn("flex-1 min-w-0 truncate text-sm sm:text-base", selectedOfficiel ? "text-foreground font-medium" : "text-muted-foreground")}
          >
      ...
      <PopoverContent
        className="w-(--radix-popover-trigger-width) max-w-[90vw] sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl p-0"
        align="start"
        sideOffset={4}
      >
        <Command>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {officiel.telephone && <div className="text-xs text-muted-foreground truncate">{officiel.telephone}</div>}
                    </div>
                  </CommandItem>
                );
              })}
