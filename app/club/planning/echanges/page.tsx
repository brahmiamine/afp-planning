...
export default function AssignmentSwapsAdminPage() {
  ...
  return <PageContainer>
    <PageHeader
      icon={<ArrowLeftRight />}
      title="Validation des échanges"
      description="Un échange accepté par les deux personnes reste sans effet tant qu’un administrateur ne l’a pas validé. Le serveur recontrôle les conflits et la disponibilité au moment de l’approbation."
    />
