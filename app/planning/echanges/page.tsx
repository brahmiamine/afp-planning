...
export default function AssignmentSwapsAdminPage() {
  ...
  return <div className="min-h-screen bg-background"><Header onScrapeComplete={() => undefined} /><main className="container mx-auto space-y-6 px-3 py-5 sm:px-4 sm:py-8">
