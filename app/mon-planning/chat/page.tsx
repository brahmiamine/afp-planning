    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto max-w-7xl px-3 py-5 sm:px-4">
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex gap-2"><Button variant="outline" onClick={() => setDirectOpen(true)}><UserRound className="mr-2 h-4 w-4" /> Nouveau message</Button>{user?.roles.includes('admin') && <Button onClick={newChannel}><Plus className="mr-2 h-4 w-4" /> Nouveau canal</Button>}</div>
        </div>
